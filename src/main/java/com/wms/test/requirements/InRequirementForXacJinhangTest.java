...
import com.wms.sdk.requirements.InRequirementForXacJinhang;
...
/**
 * @author puck
 * @date 2021/1/6 11:33 上午
 */
public class InRequirementForXacJinhangTest
{
    InRequirementForXacJinhang manager = null;
    @Before
    public void setUp() throws Exception
    {
        manager = new InRequirementForXacJinhang();
    }
