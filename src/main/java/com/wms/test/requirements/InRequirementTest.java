package com.wms.test.requirements;
...
/**
 * @author puck
 * @date 2020/12/23 6:11 下午
 */
public class InRequirementTest
{

    InRequirementManager manager = null;
    @Before
    public void setUp() throws Exception
    {
        manager = new InRequirementManager();
    }
    ...
    @Test
    public void testQueryInRequirementByOrinalOrderID()
    {
        int code = 0;
        ...
        InRequirementVo queryVo = manager.queryRequirementByOriginalOrderId(originalOrderID);
        org.junit.Assert.assertEquals(queryVo.getOriginalOrderId(),originalOrderID);
    }
